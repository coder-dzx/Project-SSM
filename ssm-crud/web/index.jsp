...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-6" id="page_info_area">
            <%--当前<span class="label label-primary"></span>页,--%>
            <%--共<span class="label label-success"></span>页,--%>
            <%--共<span class="label label-warning"></span>条记录--%>
        </div>
        <%--分页条信息--%>
...
<script type="text/javascript">
    ...
    //1、页面加载完成以后，直接发送一个ajax请求，拿到分页数据
    $(function () {
        //去首页
        to_page(1);
    });
        ...
        function getDepts(ele) {
            ...
            $.ajax({
                ...
                success:function (result) {
                    // console.log(result);
                    //显示部门信息在下拉列表中
                    // 使用id  ---->   $("#dept_add_select")
                    //不是用id  ---->   $("#empAddModal select")
        ...
        function validate_add_form() {
            ...
            if(!regName.test(empName)){
                ...
                show_validate_msg("#empName_add_input","error","用户名可以是2-5位中文或3-16位英文数字组合");
